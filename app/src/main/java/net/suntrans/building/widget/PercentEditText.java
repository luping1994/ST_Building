...
public class PercentEditText extends AppCompatEditText {
    private static final String TAG = PercentEditText.class.getSimpleName();
    ...
    public PercentEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
        getAttrs(context, attrs);
        setTextSize(getTextSize());
    }

    public PercentEditText(Context context, AttributeSet attrs, int defStyleAttr) {
